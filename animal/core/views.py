...
"""
"""
from animal.dia.models import Dia
from animal.disciplina.models import Disciplina
from animal.horario.models import Horario
from animal.turma.models import Turma
from animal.aula.models import Aula
def config(request):
